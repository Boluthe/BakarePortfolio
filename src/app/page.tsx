      ...
      <section className="mx-auto max-w-5xl px-6">
        <div className="grid min-h-screen items-center gap-12 pb-16 pt-28 lg:grid-cols-[1fr_300px] lg:gap-20">
          ...
          <div className="order-2 lg:order-1">
            ...
            <p className="anim-fade-up delay-6 mt-10 text-[13px] tracking-wide text-slate-600">
              Java&nbsp;&nbsp;·&nbsp;&nbsp;Spring Boot&nbsp;&nbsp;·&nbsp;&nbsp;React&nbsp;&nbsp;·&nbsp;&nbsp;TypeScript&nbsp;&nbsp;·&nbsp;&nbsp;PostgreSQL&nbsp;&nbsp;·&nbsp;&nbsp;Docker&nbsp;&nbsp;·&nbsp;&nbsp;Spring Security
            </p>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  >
                    ...
                    linkedin.com/in/bakare-tioluwani-96a135261
                  </a>
                  <a
