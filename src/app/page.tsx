  ...
  return (
    <RevealSection className="h-full">
      ...
      >
        ...
        <div className="space-y-4 font-mono text-xs text-slate-300 flex-1">
          <div>
          ...
          <div className="space-y-2.5 pt-2.5 border-t border-slate-800/60">
            <div className="grid grid-cols-1 sm:grid-cols-[100px_1fr] gap-1 sm:gap-2 items-baseline">
              <span className="text-emerald-400 font-bold select-none">[ CHALLENGE ]</span>
              <span className="text-slate-200 font-sans text-xs leading-relaxed line-clamp-3">{cs.problem}</span>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-[100px_1fr] gap-1 sm:gap-2 items-baseline">
              <span className="text-emerald-400 font-bold select-none">[ PLATFORM ]</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-[100px_1fr] gap-1 sm:gap-2 items-baseline">
              <span className="text-emerald-400 font-bold select-none">[ ENGINE ]</span>
        ...
        <div className="mt-5 pt-3.5 border-t border-slate-800/60 flex items-center justify-between gap-2 sm:gap-3 flex-nowrap overflow-hidden">
          <span className="font-mono text-[10px] text-slate-500 select-none min-w-0 truncate pr-1">
            $ cat docs/{cs.slug}.json
          </span>
          <span className="font-mono text-[10.5px] sm:text-[11px] font-bold text-red-400 inline-flex items-center gap-1 sm:gap-1.5 transition-all duration-300 group-hover:translate-x-1 group-hover:text-red-300 shrink-0 whitespace-nowrap">
            [ GET CASE_STUDY ]
          ...
          <div className="grid items-start gap-10 pb-12 pt-28 lg:grid-cols-[1fr_300px] lg:gap-16">
            ...
            <div className="order-2 lg:order-1">
              <div className="anim-fade-up delay-1 mb-5 flex flex-wrap items-center gap-2 text-xs font-mono">
                ...
                <span className="rounded-md border border-emerald-500/40 bg-emerald-500/15 px-2.5 py-0.5 font-bold uppercase text-emerald-400 shadow-sm shadow-emerald-500/10">
                  ● Open to Work
                </span>
                  ...
                  <div key={label}>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {items.map((item) => (
                        <span
                          key={item}
                          className="rounded border border-slate-700/70 bg-[#1e222b]/90 px-2.5 py-1 text-xs text-slate-200 shadow-sm transition-all hover:border-emerald-500/50 hover:bg-slate-800 hover:text-white"
                        >
                          {item}
                        </span>
                      ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch mt-3 sm:mt-6">
              ...
              {maisonProject && (
                <RevealSection className="col-span-1 md:col-span-2 h-full">
                  <div className="group relative rounded-2xl border border-white/[0.08] bg-[#1e222b]/90 backdrop-blur-xl shadow-2xl transition-all duration-500 hover:border-red-500/50 hover:bg-[#242832]/95 hover:shadow-[0_0_40px_-10px_rgba(239,68,68,0.2)] overflow-hidden p-6 sm:p-8 font-mono flex flex-col justify-between h-full">
                    <div>
                      {/* Top Status Bar */}
                      <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-800 pb-4 mb-5 text-xs">
                        <div className="flex items-center gap-2.5 min-w-0">
                          ...
                          <span className="text-slate-200 font-semibold select-all truncate text-xs sm:text-sm">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
                        ...
                        <div className="lg:col-span-7 space-y-4">
                          <div>
                            <h3 className="text-2xl sm:text-3xl font-bold text-white tracking-tight group-hover:text-red-400 transition-colors">
                              {maisonProject.title}
                            </h3>
                            <p className="mt-2 text-slate-300 font-sans text-sm sm:text-[15px] leading-relaxed font-normal">
                        ...
                        <div className="lg:col-span-5 flex flex-col justify-between space-y-6 lg:border-l lg:border-slate-800/80 lg:pl-8 h-full">
                          <div>
                          ...
                          {/* Action CTAs */}
                          <div className="pt-4 border-t border-slate-800/80 flex flex-wrap items-center gap-3.5">
                            <Link
              ...
              {inventoryProject && <StandardCaseStudyCard cs={inventoryProject} />}
              {rencashProject && <StandardCaseStudyCard cs={rencashProject} />}
            </div>
          </div>
        </section>
            ...
            <RevealSection>
              ...
              <div className="flex flex-wrap items-end justify-between gap-4 border-b border-white/[0.08] pb-4 mb-4 sm:pb-6 sm:mb-8 sm:gap-6">
                <div>
                  ...
                  <p className="font-mono text-3xl sm:text-4xl font-bold leading-tight tracking-tight text-white">
                    Available_for_work()
                  </p>
                </div>
                <p className="max-w-md text-sm sm:text-base font-medium text-slate-300 font-sans">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mt-3 sm:mt-8">
                ...
                <div className="lg:col-span-7 w-full flex flex-col gap-6">
                  ...
                  <div className="lg:hidden w-full rounded-2xl border border-white/[0.08] bg-[#1e222b]/95 backdrop-blur-md px-6 py-4 flex items-center justify-between shadow-xl ring-1 ring-white/[0.04]">
                    {/* Email Icon */}
                    <a
                      href="mailto:bakaretioluwani@yahoo.com"
                      className="p-2 text-slate-300 hover:text-emerald-400 hover:scale-110 transition-all duration-300"
                      title="Email"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-2 text-slate-300 hover:text-pink-400 hover:scale-110 transition-all duration-300"
                      title="Instagram"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-2 text-slate-300 hover:text-blue-400 hover:scale-110 transition-all duration-300"
                      title="LinkedIn"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-2 text-slate-300 hover:text-white hover:scale-110 transition-all duration-300"
                      title="GitHub"
                    >
                      <svg width="22" height="22" className="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="hidden lg:flex lg:col-span-5 flex-col justify-between gap-4 w-full h-full">
                  ...
                  <a
                    href="mailto:bakaretioluwani@yahoo.com"
                    className="group relative overflow-hidden flex-1 flex items-center gap-4 rounded-2xl border border-white/[0.08] bg-[#1e222b]/80 backdrop-blur-md px-5 py-5 transition-all duration-300 hover:-translate-y-1 hover:border-emerald-500/50 hover:bg-[#242832]/90 hover:shadow-xl hover:shadow-[0_0_30px_-5px_rgba(16,185,129,0.2)]"
                  >
                    ...
                    <div className="relative z-10 flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500/25 to-teal-500/15 text-emerald-400 ring-1 ring-emerald-500/40 shadow-md shadow-emerald-500/10 transition-all duration-300 group-hover:scale-110 group-hover:ring-emerald-400">
                      <svg width="20" height="20" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.6}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                      </svg>
                    </div>
                    <div className="relative z-10 min-w-0 flex-1">
                      <p className="text-[14px] font-bold text-white tracking-wider transition-colors group-hover:text-emerald-400 font-mono">Email</p>
                      <p className="text-[11px] text-slate-300 mt-0.5 font-medium tracking-wide truncate font-mono">bakaretioluwani@yahoo.com</p>
                    </div>
                    <svg width="16" height="16" className="ml-auto h-4 w-4 shrink-0 text-slate-500 transition-all duration-300 group-hover:translate-x-1 group-hover:text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                    </svg>
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative overflow-hidden flex-1 flex items-center gap-4 rounded-2xl border border-white/[0.08] bg-[#1e222b]/80 backdrop-blur-md px-5 py-5 transition-all duration-300 hover:-translate-y-1 hover:border-pink-500/50 hover:bg-[#242832]/90 hover:shadow-xl hover:shadow-[0_0_30px_-5px_rgba(236,72,153,0.2)]"
                  >
                    ...
                    <div className="relative z-10 min-w-0 flex-1">
                      ...
                      <p className="text-[11px] text-slate-300 mt-0.5 font-medium tracking-wide truncate font-mono">Bakare Tioluwani Boluwatife</p>
                    </div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative overflow-hidden flex-1 flex items-center gap-4 rounded-2xl border border-white/[0.08] bg-[#1e222b]/80 backdrop-blur-md px-5 py-5 transition-all duration-300 hover:-translate-y-1 hover:border-blue-500/50 hover:bg-[#242832]/90 hover:shadow-xl hover:shadow-[0_0_30px_-5px_rgba(59,130,246,0.2)]"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative overflow-hidden flex-1 flex items-center gap-4 rounded-2xl border border-white/[0.08] bg-[#1e222b]/80 backdrop-blur-md px-5 py-5 transition-all duration-300 hover:-translate-y-1 hover:border-slate-300/50 hover:bg-[#242832]/90 hover:shadow-xl hover:shadow-[0_0_30px_-5px_rgba(203,213,225,0.2)]"
                  >
