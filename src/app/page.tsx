  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-5xl px-6">
        <div className="grid items-center gap-10 pb-12 pt-28 lg:grid-cols-[1fr_300px] lg:gap-16">
          ...
          <div className="anim-fade-up delay-2 order-1 flex justify-center lg:order-2 lg:justify-end">
            <div className="relative">
              <div className="absolute -inset-px rounded-2xl bg-gradient-to-br from-red-500/30 via-transparent to-red-500/10" />
              <div className="relative w-56 overflow-hidden rounded-2xl bg-slate-900 border border-slate-700/80 shadow-2xl shadow-black/80 sm:w-64 lg:w-72">
                <Image
                  src="/profile.jpg"
      ...
      {/* ── Work ── */}
      <section id="work" className="border-t border-white/[0.08] scroll-mt-20">
        <div className="mx-auto max-w-5xl px-6 py-14">

          <RevealSection>
            <h2 className="font-mono text-xs font-bold text-slate-400">
              {"// 02 — Selected Work"}
            </h2>
          </RevealSection>
            ...
            {caseStudies.map((cs, i) => (
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center justify-between border-b border-slate-800 pb-3.5 mb-4 font-mono text-[10px] sm:text-xs">
                    <div className="flex items-center gap-2">
                      <span className={`rounded px-1.5 py-0.5 font-bold border tracking-wider text-[9px] ${methodColors[endpoints[cs.slug]?.method || "GET"]}`}>
                        {endpoints[cs.slug]?.method || "GET"}
                      </span>
                      <span className="text-slate-200 font-semibold select-all truncate max-w-[140px] sm:max-w-none">
                        {endpoints[cs.slug]?.route}
                      </span>
                    </div>
                    <span className={`rounded-full border px-2.5 py-0.5 text-[10px] font-medium tracking-wide ${statusColors[cs.status]}`}>
                      {cs.status}
                    </span>
                  </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:items-start">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group relative overflow-hidden flex items-center gap-4 rounded-2xl border border-white/[0.08] bg-[#1e222b]/80 backdrop-blur-md px-5 py-4 transition-all duration-300 hover:-translate-y-1 hover:border-red-500/50 hover:bg-[#242832]/90 hover:shadow-xl hover:shadow-[0_0_30px_-5px_rgba(239,68,68,0.15)]"
                >
                  ...
                  <div className="relative z-10 flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-red-500/15 text-red-400 ring-1 ring-red-500/30 transition-all duration-300 group-hover:scale-110 group-hover:bg-red-500/25">
                    <svg width="20" height="20" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" />
                    </svg>
                  </div>
                  <div className="relative z-10 min-w-0 flex-1">
                    <p className="text-[14px] font-bold text-white tracking-wider transition-colors group-hover:text-red-400 font-mono">WhatsApp</p>
                    <p className="text-[11px] text-slate-300 mt-0.5 font-medium tracking-wide truncate font-mono">+234 915 460 4723</p>
                  </div>
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-red-500/10 via-transparent to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                  <div className="relative z-10 flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-slate-800 text-red-400 ring-1 ring-white/10 transition-all duration-300 group-hover:scale-110 group-hover:bg-slate-700">
                    <svg width="20" height="20" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                    </svg>
                  </div>
                  <div className="relative z-10 min-w-0 flex-1">
                    <p className="text-[14px] font-bold text-white tracking-wider transition-colors group-hover:text-red-400 font-mono">LinkedIn</p>
                    <p className="text-[11px] text-slate-300 mt-0.5 font-medium tracking-wide truncate font-mono">Tioluwani Bakare</p>
                  </div>
                  <svg width="16" height="16" className="ml-auto h-4 w-4 shrink-0 text-slate-500 transition-all duration-300 group-hover:translate-x-1 group-hover:text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                  </svg>
                ...
                >
                  ...
                  <div className="relative z-10 min-w-0 flex-1">
                    <p className="text-[14px] font-bold text-white tracking-wider transition-colors group-hover:text-red-400 font-mono">GitHub</p>
                    <p className="text-[11px] text-slate-300 mt-0.5 font-medium tracking-wide truncate font-mono">boluthe</p>
                  </div>
                  <svg width="16" height="16" className="ml-auto h-4 w-4 shrink-0 text-slate-500 transition-all duration-300 group-hover:translate-x-1 group-hover:text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                  </svg>
      ...
      <footer className="border-t border-slate-800/80 px-6 py-8 pb-20">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-white/[0.1] bg-[#262a33]/95 backdrop-blur-md px-6 py-2.5 text-[10px] font-mono font-medium text-slate-200 flex justify-between items-center sm:text-xs select-none shadow-2xl">
