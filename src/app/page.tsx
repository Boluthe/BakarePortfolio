  ...
  return (
    <>
      ...
      <section className="relative mx-auto max-w-5xl px-6">
        {/* Single warm glow — gives the page depth without rainbow chaos */}
        <div className="pointer-events-none absolute right-0 top-0 -z-10 h-[600px] w-[600px] rounded-full bg-orange-500/6 blur-[120px]" />
        ...
        <div className="grid min-h-screen items-center gap-12 pb-16 pt-28 lg:grid-cols-[1fr_300px] lg:gap-20">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="anim-fade-up delay-5 mt-8 flex flex-wrap items-center gap-3">
              ...
              <a
                href="#contact"
                className="rounded-lg border border-indigo-500/30 bg-indigo-500/10 px-5 py-2.5 text-sm font-semibold text-indigo-300 transition-all hover:bg-indigo-500/20 hover:border-indigo-400/50"
              >
                Get in touch
              </a>
            </div>
          ...
          <div className="anim-fade-up delay-2 order-1 flex justify-center lg:order-2 lg:justify-end">
            <div className="relative">
              {/* Indigo accent ring — the one pop of a second colour on the photo */}
              <div className="absolute -inset-px rounded-2xl bg-gradient-to-br from-orange-500/30 via-transparent to-indigo-500/20" />
              ...
              <div className="absolute -inset-6 -z-10 rounded-3xl bg-orange-500/8 blur-2xl" />
            </div>
          </div>
          ...
          <div className="mt-10 divide-y divide-white/[0.05]">
            {caseStudies.map((cs, i) => (
              ...
              >
                ...
                >
                  <span className="mt-1 w-6 shrink-0 font-mono text-xs text-orange-500/60">
                    0{i + 1}
                  </span>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className="mt-4 inline-flex items-center gap-1.5 text-xs text-orange-400 opacity-0 transition-opacity group-hover:opacity-100">
                      Read case study
                      <svg
      ...
      {/* ── Contact ── */}
      <section id="contact" className="relative border-t border-white/[0.06] scroll-mt-20">
        {/* Indigo glow anchors the bottom of the page */}
        <div className="pointer-events-none absolute left-1/2 top-0 -z-10 h-[400px] w-[600px] -translate-x-1/2 rounded-full bg-indigo-500/5 blur-[100px]" />
            ...
            <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
              ...
              <div className="grid gap-3">
                ...
                <a
                  ...
                  className="group flex items-center gap-4 rounded-xl border border-slate-800 bg-slate-800/30 px-5 py-4 transition-all hover:border-orange-500/30 hover:bg-orange-500/5"
                >
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-orange-500/15 text-orange-400 ring-1 ring-orange-500/20">
                  ...
                  <svg className="ml-auto h-4 w-4 shrink-0 text-slate-600 transition-transform group-hover:translate-x-0.5 group-hover:text-orange-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                  </svg>
                </a>
                ...
                <a
                  ...
                  className="group flex items-center gap-4 rounded-xl border border-slate-800 bg-slate-800/30 px-5 py-4 transition-all hover:border-indigo-500/30 hover:bg-indigo-500/5"
                >
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-indigo-500/15 text-indigo-400 ring-1 ring-indigo-500/20">
                  ...
                  <svg className="ml-auto h-4 w-4 shrink-0 text-slate-600 transition-transform group-hover:translate-x-0.5 group-hover:text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                  </svg>
                </a>
                ...
                >
                  ...
                  <svg className="ml-auto h-4 w-4 shrink-0 text-slate-600 transition-transform group-hover:translate-x-0.5 group-hover:text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
                  </svg>
                </a>
              </div>
