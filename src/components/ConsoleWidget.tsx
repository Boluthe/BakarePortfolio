...
export default function ConsoleWidget() {
  ...
  return (
    <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg rounded-2xl border border-white/[0.08] bg-[#1f232b]/90 backdrop-blur-lg shadow-2xl shadow-black/80 overflow-hidden font-sans">
      {/* Console Header Bar */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/[0.08] bg-[#16181d]/95">
